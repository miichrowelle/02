...
const rules = {
  "milk-kefir": {
    ...
    maxTemp: 30,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Place kefir grains in jar, add room-temperature milk" },
      ...
      { step: "Ready", offsetHours: null, description: "Kefir is ready! Store in fridge, consume within 3-5 days" },
    ],
  ...
  "buttermilk": {
    ...
    maxTemp: 27,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Add 2 tbsp store-bought buttermilk or culture to room-temperature milk" },
      { step: "Fermentation", offsetHours: null, description: "Fermentation in progress" },
      { step: "Check", offsetHours: 12, description: "Should be thick and tangy. Shake gently to mix" },
      { step: "Ready", offsetHours: null, description: "Chill before drinking. Keeps 1-2 weeks refrigerated" },
    ],
  ...
  "water-kefir": {
    ...
    maxTemp: 28,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Dissolve sugar in water, add kefir grains and optional dried fruit" },
      ...
      { step: "Ready", offsetHours: null, description: "Refrigerate and enjoy! Consume within 1 week" },
    ],
    checkIntervalHours: 12,
  },
  ...
  "kombucha": {
    ...
    maxTemp: 30,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Brew tea, add sugar, let cool to room temperature" },
      ...
      { step: "Ready", offsetHours: null, description: "Refrigerate and enjoy! Burp bottles daily if needed" },
    ],
  ...
  "kimchi": {
    ...
    maxTemp: 30,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Salt Napa cabbage and radish, let sit 2 hours to draw out water" },
      { step: "Fermentation", offsetHours: null, description: "Fermentation in progress" },
      { step: "Check", offsetHours: 48, description: "Check fermentation progress" },
      { step: "Ready", offsetHours: null, description: "Transfer to fridge. Flavor improves for 1-2 weeks" },
    ],
  ...
  "pickled-vegetables": {
    ...
    maxTemp: Infinity,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Mix 2-3% salt by weight in water, pack vegetables tightly in jar" },
      { step: "Fermentation", offsetHours: null, description: "Fermentation in progress" },
      { step: "Check", offsetHours: 24, description: "Check that vegetables stay submerged, skim any surface mold" },
      { step: "Ready", offsetHours: null, description: "Transfer to fridge. Keeps 2-3 months refrigerated" },
    ],
    checkIntervalHours: 24,
  },
  ...
  "sauerkraut": {
    ...
    maxTemp: 28,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Shred cabbage, add 2% salt by weight, pack tightly in jar" },
      ...
      { step: "Ready", offsetHours: null, description: "Transfer to fridge. Will keep for months refrigerated" },
    ],
  ...
  "sourdough-starter": {
    ...
    maxTemp: 28,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Mix equal parts flour and water (50g each), stir well" },
      { step: "Fermentation", offsetHours: null, description: "Fermentation in progress" },
      { step: "Check", offsetHours: 24, description: "Look for bubbles and rise - sign of active fermentation" },
      { step: "Ready", offsetHours: null, description: "Starter should double in size after feeding. Ready to use or refrigerate" },
    ],
    checkIntervalHours: 24,
  },
  ...
  "sourdough-bulk": {
    ...
    maxTemp: 30,
    steps: [
      { step: "Fill", offsetHours: 0, description: "Mix flour, water, and active starter" },
      ...
      { step: "Ready", offsetHours: null, description: "Dough should be puffy and jiggly. Shape and proof" },
    ],
    checkIntervalHours: 12,
  },
};
